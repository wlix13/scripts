...
sudo apt install whois iputils-ping git net-tools dnsutils bind9-host mtr ipcalc grepcidr nmap ncat aha -y

# Install asn lookup
wget https://raw.githubusercontent.com/nitefood/asn/master/asn && chmod +x asn && sudo mv asn /usr/bin/asn
