...
grep -q "alias bat='batcat --style=plain'" ~/.zshrc || echo "alias bat='batcat --style=plain'" >> ~/.zshrc
...
if [ "$(uname -m)" = "x86_64" ]; then
    ...
    curl --compressed \
         ...
         --proto '=https' \
         --tlsv1.2 \
         -fsSLO https://github.com/neovim/neovim/releases/download/v0.11.4/nvim-linux-x86_64.appimage
...
curl --compressed \
     ...
     --proto '=https' \
     --tlsv1.2 \
     -fsSL https://github.com/tmux/tmux/releases/download/3.3a/tmux-3.3a.tar.gz --output tmux.tar.gz
